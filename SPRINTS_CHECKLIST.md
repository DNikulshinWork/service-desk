...
- [x] Результат тестов: 11/11 файлов, 22/22 тестов успешно
...
- [x] Последние коммиты зафиксированы:
  ...
  - `bf5489d` feat(api): add role-based access for tickets
...
- [x] Продолжить Sprint 2: детали заявки, обновление, комментарии, вложения
- [x] Продолжить Sprint 2: роли доступа для заявок
- [x] Продолжить Sprint 2: Интеграционные тесты для Sprint 2
- [ ] Осталась последняя задача в спринте: Фильтрация, пагинация и сортировка
