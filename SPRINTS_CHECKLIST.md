...
- [x] Связь заявки со статьёй
- [x] Интеграционные тесты для Sprint 3

## Sprint 4
- [x] CRUD SLA-политик
- [x] CRUD рабочих календарей
- [x] Расчёт дедлайнов
- [x] Статус SLA по заявке
- [x] Автоматические задачи по дедлайнам
- [x] Email/webhook уведомления
- [x] Интеграционные тесты для Sprint 4

## Sprint 5
- [ ] Интеграции с Telegram/Slack
- [x] Отчёты по статусам, агентам и CSAT
- [ ] Экспорт отчётов
- [ ] Кеширование отчётов
- [ ] Dashboard метрик
...
- [x] Результат тестов: 18/18 файлов, 47/47 тестов успешно
- [ ] Ошибки TypeScript/IDE для API не обнаружены

## Git / коммиты
- [x] Последние коммиты зафиксированы:
  - `fix(api): correct report generation and tests`
...
## Следующий шаг
- [x] Sprint 4 завершён
- [ ] Начать Sprint 5: интеграции и отчёты
